...
export const PatientRecords = () => {
  // We'll reuse similar mock data for the list view
  const records = [
    { id: 'REC-001', date: '2026-07-23', title: 'Complete Blood Count (CBC)', provider: 'ABC Diagnostic Center', status: 'PROVIDER_VERIFIED' as const },
    { id: 'REC-002', date: '2026-07-21', title: 'General Checkup', provider: 'Dr. Sarah Smith', status: 'PROVIDER_VERIFIED' as const },
    { id: 'REC-003', date: '2019-04-15', title: 'Appendectomy Report', provider: 'City Hospital', status: 'PATIENT_UPLOADED' as const },
  ];
